---
name: vendor-hcaptcha
description: |
  Beginner-friendly reverse-engineering workflow for Vendor Hcaptcha. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
