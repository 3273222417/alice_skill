...
name: web-zhihu-zse
description: |
  Beginner-friendly reverse-engineering workflow for Web Zhihu Zse. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
