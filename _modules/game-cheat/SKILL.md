---
name: game-cheat
description: Game hacking toolkit: memory trainer, DLL injection, aimbot/ESP math, speedhack patterns, currency manipulation, packet interception. Trigger: cheat, trainer, aimbot, esp, wallhack, speedhack, game hack, memory edit, inject dll, gold hack, currency hack, no recoil, triggerbot.
x-alice-class: game
