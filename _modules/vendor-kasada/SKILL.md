...
name: vendor-kasada
description: |
  Beginner-friendly reverse-engineering workflow for Vendor Kasada. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
