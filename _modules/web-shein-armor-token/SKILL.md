---
name: web-shein-armor-token
description: |
  Beginner-friendly reverse-engineering workflow for Web Shein Armor Token. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
