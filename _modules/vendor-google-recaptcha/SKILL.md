---
name: vendor-google-recaptcha
description: |
  Beginner-friendly reverse-engineering workflow for Vendor Google Recaptcha. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
