---
name: web-trip-phantom-token
description: |
  Beginner-friendly reverse-engineering workflow for Web Trip Phantom Token. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
