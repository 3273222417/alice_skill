...
> - [`_shared/references/elite-chaining-strategy.md`（未随包分发，正文自足）](../_shared/references/elite-chaining-strategy.md) — Exploit chaining methodology and high-payout chain patterns
> - [`_shared/references/elite-report-writing.md`（未随包分发，正文自足）](../_shared/references/elite-report-writing.md) — HackerOne-optimized report writing, CWE quick reference
> - [`_shared/references/real-world-bounties.md`（未随包分发，正文自足）](../_shared/references/real-world-bounties.md) — Verified disclosed bounties by vulnerability class
