---
name: vendor-tencent-tcaptcha
description: |
  Beginner-friendly reverse-engineering workflow for Vendor Tencent Tcaptcha. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
