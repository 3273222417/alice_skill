---
name: vendor-cloudflare-waf
description: |
  Beginner-friendly reverse-engineering workflow for Vendor Cloudflare Waf. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
