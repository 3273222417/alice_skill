---
name: vendor-perimeterx
description: |
  Beginner-friendly reverse-engineering workflow for Vendor Perimeterx. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
