...
Build a timeline and state which observations are server-confirmed, client-reported, inferred, or missing. Preserve raw evidence and analysis scripts in `$eni-case-lab`.
