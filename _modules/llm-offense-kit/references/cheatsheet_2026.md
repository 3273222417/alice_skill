...
> 提炼时间 2026-08-10 03:49 · 来源 GitHub

> ⚠️ 仅用于授权靶场 / CTF / 实验环境。经典 DAN/忽略指令对现代 RLHF 模型效果有限，本速查聚焦架构级与管线级攻击（推理劫持/工具链/RAG 污染/多模态/记忆腐化/编码绕过）。
...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/alice/pulls)
...
## Related Links
- Main Site: [🔬 Cybersecurity Standard Model](https://)
