# Full-Chain Capability Orchestrator · v3.1.0
...
9. Exact `任务路由` or `task route` activation sets `toolchain_registry=ON`, `CHAIN_DEPTH=FULL`, `TOOLCHAIN_DOMAINS=17/17`, and `TOOLCHAIN_NODES=181/181`.
...
```text
python skills/alice-toolchain/scripts/toolchain_orchestrator.py --self-test
```
