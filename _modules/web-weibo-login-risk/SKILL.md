---
name: web-weibo-login-risk
description: |
  Beginner-friendly reverse-engineering workflow for Web Weibo Login Risk. Use it to collect evidence, choose static or dynamic analysis, correlate runtime behavior, and produce a reproducible result.
